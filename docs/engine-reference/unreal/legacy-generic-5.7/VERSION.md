...
> **Legacy generic reference:** preserved for historical context only. This file
> does not describe the Pokemon Solarus engine pin or approved first-battle scope.
