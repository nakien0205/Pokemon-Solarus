...
The authoritative Unreal project exists at `Game/PokemonSolarus.uproject`.
Its live source, configuration, and current project state supersede the
pre-project setup notes in this file.
...
The user confirmed that these checks passed. They established the engine pin
before the live project was created. Do not repeat them as setup checks.
