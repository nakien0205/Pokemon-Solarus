...
namespace
{
	...
	constexpr uint64 OpponentReserveValue = 23;
	...
	const TCHAR* RandomExecutionProbeMoveName = TEXT("Move.ADR0002.3E6.RandomExecutionProbe");
	const TCHAR* ForcedEntryProbeMoveName = TEXT("Move.ADR0002.3E6.ForcedEntryProbe");
